            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="text-base text-gray-300 mb-6 uppercase">visual & product designer</p>
                ...
                <div className="text-center relative z-10">
                  <div className="text-2xl font-light text-white mb-2 uppercase">portfolio</div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div className="text-2xl font-light text-white uppercase">portfolio</div>
                </div>

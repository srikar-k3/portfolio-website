        ...
        <div className="max-w-6xl mx-auto py-24">
          ...
          <div className="space-y-24">
            ...
            >
              ...
              <div>
                <h3 className="text-4xl font-semibold text-black mb-6">KEY FEATURES</h3>
          ...
          <motion.section
            ...
            className="py-16"
          >
            <h3 className="text-4xl font-semibold text-black text-center mb-8">NEXT STEPS</h3>
            ...
            <div className="text-gray-600 text-lg leading-relaxed space-y-6">
              ...
              <ol className="list-decimal pl-6 space-y-4">
                <li>
                  <span className="font-medium text-black">Open-Source Version</span>
                ...
                <li>
                  <span className="font-medium text-black">Native macOS App</span>
                  <ul className="list-disc pl-6 mt-2 space-y-2">
            ...
            <div className="text-center mt-12">
              <a 
                ...
                className="inline-flex items-center px-8 py-4 bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-200 text-lg font-medium group"
              >
